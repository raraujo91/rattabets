...
export default function HeroCard({ available, id }) {
    const [packedHero, setPackedHero] = useState(!available)
    ...
    return (
        <div>{packedHero && (
            <div className={`${selectedHero ? '' : 'hidden'} absolute flex items-center justify-center top-0 w-full min-h-screen bg-[rgba(0,0,0,0.95)] backdrop-blur-sm`}>
